...
if ( !function_exists( 'unitravel_get_template_page_link' ) ) {
	//Handler of the add_filter('post_type_archive_link', 'unitravel_get_template_page_link', 10, 2 );
...
if ( !function_exists( 'unitravel_wp_title' ) ) {
	// Handler of the add_filter( 'wp_title', 'unitravel_wp_title');
	// Handler of the add_filter( 'wp_title_parts', 'unitravel_wp_title');
	// Handler of the add_filter( 'document_title_parts', 'unitravel_wp_title');
...
if ( ! function_exists('unitravel_get_privacy_text' ) ) {
	function unitravel_get_privacy_text() {
		...
		return apply_filters( 'unitravel_filter_privacy_text', wp_kses_post(
				$privacy_text
