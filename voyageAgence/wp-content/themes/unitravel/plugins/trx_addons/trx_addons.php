...
if (!function_exists('unitravel_trx_addons_allow_override_options')) {
	//Handler of the add_filter( 'unitravel_filter_allow_override_options', 'unitravel_trx_addons_allow_override_options', 10, 2);
...
if (!function_exists('unitravel_trx_addons_override_options_fields')) {
	//Handler of the add_filter( 'trx_addons_filter_override_options_fields', 'unitravel_trx_addons_override_options_fields', 10, 2);
