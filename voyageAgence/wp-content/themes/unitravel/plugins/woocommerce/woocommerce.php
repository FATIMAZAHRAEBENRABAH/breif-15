...
if ( !function_exists( 'unitravel_woocommerce_shop_loop_subcategory_title' ) ) {
	...
	function unitravel_woocommerce_shop_loop_subcategory_title($cat) {
		...
		<?php
		unitravel_show_layout($cat->name);
...
if ( ! function_exists( 'unitravel_woocommerce_price_filter_widget_step' ) ) {
    add_filter('woocommerce_price_filter_widget_step', 'unitravel_woocommerce_price_filter_widget_step');
    function unitravel_woocommerce_price_filter_widget_step( $step = '' ) {
        $step = 1;
        return $step;
    }
}
...
#review_form #respond p.form-submit input[type="submit"][disabled] {
...
.shop_mode_thumbs .unitravel_shop_mode_buttons a.woocommerce_thumbs,
...
.widget.woocommerce .button:hover, .widget.WOOCS_CONVERTER .button:hover, 
.widget.yith-woocompare-widget a.button:hover, .widget.yith-woocompare-widget a.clear-all:hover,
